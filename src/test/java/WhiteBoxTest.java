...
public class WhiteBoxTest {
    ...
    ConcreteCharacter char2;
    ConcreteCharacter char3;
    ConcreteCharacter char4;
    ConcreteCharacter char5;
    Weapon weapon1;
    Weapon weapon2;
    Weapon weapon3;
    Weapon weapon4;
    Weapon weapon5;
    PermanentItem item;
    TemporaryItem potion;
    Dungeon dungeon;
    MudRealm mudRealm;
    CandyRealm candyRealm;
    ...
    @Test
    public void testSetEnemyHPIceRealm2() {
